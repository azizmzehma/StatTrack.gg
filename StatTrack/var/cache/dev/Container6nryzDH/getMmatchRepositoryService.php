 ...
 */
class getMmatchRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MmatchRepository' shared autowired service.
     *
     * @return \App\Repository\MmatchRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MmatchRepository.php';

        return $container->privates['App\\Repository\\MmatchRepository'] = new \App\Repository\MmatchRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
