 ...
 */
class getMatchesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MatchesRepository' shared autowired service.
     *
     * @return \App\Repository\MatchesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MatchesRepository.php';

        return $container->privates['App\\Repository\\MatchesRepository'] = new \App\Repository\MatchesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
